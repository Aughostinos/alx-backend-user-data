...
*   [REST API Authentication Mechanisms - Only the session auth part](/rltoken/oofk0VhuS0ZFZTNTVrQeaQ "REST API Authentication Mechanisms - Only the session auth part")
*   [HTTP Cookie](/rltoken/peLV8xuJ4PDJMOVFqk-d2g "HTTP Cookie")
*   [Flask](/rltoken/yrCaeZxNcpagOLh-0SVhwA "Flask")
*   [Flask Cookie](/rltoken/QYfI5oW6OHUmHDzwKV1Qsw "Flask Cookie")

Learning Objectives
-------------------

At the end of this project, you are expected to be able to [explain to anyone](/rltoken/uWXp4VcY3Dd9UzTtc9N5_A "explain to anyone"), **without the help of Google**:
...
#### Correction of "10. Sessions in database"
